...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/verbosity_pkg.sv"              -work altera_common_sv_packages
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/auk_dspip_text_pkg.vhd"        -work fft_ii_0                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/auk_dspip_math_pkg.vhd"        -work fft_ii_0                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/auk_dspip_lib_pkg.vhd"         -work fft_ii_0                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/auk_dspip_roundsat.vhd"        -work fft_ii_0                 
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0.sv"       -work fft_ii_0                 
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/altera_avalon_reset_source.sv" -work fftSpectrum_inst_rst_bfm 
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/altera_avalon_clock_source.sv" -work fftSpectrum_inst_clk_bfm 
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum.v"                 -work fftSpectrum_inst         
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/fftSpectrum_tb/simulation/fftSpectrum_tb.v"                                                        
fi
