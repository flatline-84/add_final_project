...
mkdir -p ./libraries/fftSpectrum_inst_rst_bfm/
mkdir -p ./libraries/fftSpectrum_inst_clk_bfm/
mkdir -p ./libraries/fftSpectrum_inst/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0_opt_twr1.hex ./
  cp -f $QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0_opt_twi2.hex ./
  cp -f $QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0_opt_twr2.hex ./
  cp -f $QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0_opt_twi3.hex ./
  cp -f $QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0_opt_twi4.hex ./
  cp -f $QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0_opt_twr3.hex ./
  cp -f $QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0_opt_twi1.hex ./
  cp -f $QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0_opt_twr4.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/verbosity_pkg.sv"              -work altera_common_sv_packages -cdslib ./cds_libs/altera_common_sv_packages.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/auk_dspip_text_pkg.vhd"        -work fft_ii_0                  -cdslib ./cds_libs/fft_ii_0.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/auk_dspip_math_pkg.vhd"        -work fft_ii_0                  -cdslib ./cds_libs/fft_ii_0.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/auk_dspip_lib_pkg.vhd"         -work fft_ii_0                  -cdslib ./cds_libs/fft_ii_0.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/auk_dspip_roundsat.vhd"        -work fft_ii_0                  -cdslib ./cds_libs/fft_ii_0.cds.lib                 
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum_fft_ii_0.sv"       -work fft_ii_0                  -cdslib ./cds_libs/fft_ii_0.cds.lib                 
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/altera_avalon_reset_source.sv" -work fftSpectrum_inst_rst_bfm  -cdslib ./cds_libs/fftSpectrum_inst_rst_bfm.cds.lib 
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/altera_avalon_clock_source.sv" -work fftSpectrum_inst_clk_bfm  -cdslib ./cds_libs/fftSpectrum_inst_clk_bfm.cds.lib 
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/fftSpectrum_tb/simulation/submodules/fftSpectrum.v"                 -work fftSpectrum_inst          -cdslib ./cds_libs/fftSpectrum_inst.cds.lib         
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/fftSpectrum_tb/simulation/fftSpectrum_tb.v"                                                                                                             
fi
